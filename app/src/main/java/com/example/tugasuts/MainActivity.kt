...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val konfirmasiPassword = findViewById<EditText>(R.id.editTextTextPassword)
        ...
        btnKirim.setOnClickListener {
            ...
            val namaLengkap = "${namaDepan.text} ${namaBelakang.text}"
            Toast.makeText(this, "Registrasi Berhasil! Selamat datang, $namaLengkap", Toast.LENGTH_LONG).show()
                   }
            }
}
